Shader "Custom/CustomVFX"
{
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
            ...
            struct Bindings_SGBillbord_8e97989005e2bd740a5e9be574830c38_float
            {
            ...
            float3 GetLifeTime(half _DebugTime, half _ManualTime, half _ParticleSpeed, half colorR)
            {
                ...
                {
                    lifeTime = _Time.y * _ParticleSpeed;
                }
            ...
            Varyings UnlitPassVertex(Attributes IN) 
            {
                ...
                float3 GravityAndWind = TransformWorldToObject(_Wind + _Gravityy + SHADERGRAPH_OBJECT_POSITION) * lifeTime.y;
                ...
                //float3 forwardAxiz = IN.positionOS.xyz;
                //float3 positiveX = (forwardAxiz * float3(1,1,-1)).yzx; //yzx
                //float3 negativeX = -forwardAxiz.yzx;
                //float3 positiveY =  -forwardAxiz.xzy;
                //float3 negativeY = (forwardAxiz * float3(1,-1,-1)).xzy;
                //float3 positiveZ = forwardAxiz * float3(-1,1,1);
                //float3 negativeZ = forwardAxiz;
				...
				//OUT.color = GetVertexNormalInputs(IN.normalOS).normalWS.rgbb;
				return OUT;
			}
