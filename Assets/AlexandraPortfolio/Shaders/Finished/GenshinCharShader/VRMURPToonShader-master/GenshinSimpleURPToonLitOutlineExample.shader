...
*/ 
Shader "GenshinSimpleURPToonLitExample(With Outline)"
{
    Properties
    {
        ...
        [Header(Base Color)]
        [ToggleUI]_IsTextureRef("Should use texture data as reference for brightness?", Float) = 0
        _BrightestTextureColor("Brightest texture color", Color) = (0.1,0.1,0.1,1) // Use as multipliyer for texture brightness
