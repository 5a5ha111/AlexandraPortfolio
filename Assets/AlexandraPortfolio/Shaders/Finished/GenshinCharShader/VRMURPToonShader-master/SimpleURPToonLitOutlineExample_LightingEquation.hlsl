...
half3 CompositeAllLightResults(half3 indirectResult, half3 mainLightResult, half3 additionalLightSumResult, half3 emissionResult, ToonSurfaceData surfaceData, ToonLightingData lightingData)
{
    ...
    half rawLightSumAverge = (rawLightSum.r + rawLightSum.g + rawLightSum.b) / 3 ;
    half3 rawLightSumRes = lerp(rawLightSum, rawLightSumAverge, _DirectLightMultiplier);
    return surfaceData.albedo * rawLightSumRes + emissionResult;
}
