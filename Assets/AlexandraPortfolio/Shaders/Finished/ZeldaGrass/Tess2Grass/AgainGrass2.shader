    ...
    SubShader
    {
        ...
        HLSLINCLUDE
            ...
            /*TessellationControlPoint vert(Attributes v)
            {
                ...
                OUT.normal = v.normalOS;
                OUT.uv = v.uv;
                //OUT.color = v.color;
         
                OUT.normal = TransformObjectToWorldNormal(v.normalOS);
                OUT.tangent = v.tangentOS;
                return OUT;
            }*/

            /*// pos shader which translates from object to world space.
            TessellationControlPoint geomVert (Attributes v)
            {
            ...
            void geom(point Interpolators input[1], inout TriangleStream<g2f> triStream)
            {
                ...
                offsetPos = offsetPos * SG_MaskSquere(input[0].uv, 100);
                ...
                float WindAmplitude = 20.0f/* * voronoiOut*/; //80
            ...
            Varyings UnpackVaryings (g2f input)
            {
                Varyings output;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                ...
                float4 frag (g2f i) : SV_Target
                {
                    ...
                    surface.albedo = lerp(_BaseColor, lerp(_TipColor, _OldColor, i.height / 1.25), i.uv.y);
                    surface.alpha = 1;
                    surface.metallic = 0;
