...
[ExecuteInEditMode]
public class ProceduralGrassRenderer2 : MonoBehaviour
{
    ...
    {
        Debug.Assert(grassComputeShader != null, "The gras compute shader is null!", gameObject);
        ...
        instantiatedGrassComputeShader.SetFloat("_MaxBladeSegments", grassSettings.maxSegments);
        ...
        instantiatedGrassComputeShader.SetFloat("_BladeHeightVeriance", grassSettings.bladeHeightVariance);
        instantiatedGrassComputeShader.SetFloat("_BladeWidth", grassSettings.bladeWidth);
        instantiatedGrassComputeShader.SetFloat("_BladeWidthVarience", grassSettings.bladeWidthVariance);
    ...
    private void LateUpdate()
    {
        ...
        triVertComputeshader.Dispatch(idTriKernel, 1, 1, 1);*/

        /*int[] inderectargs = new int[1];
        argsBuffer.GetData(inderectargs);*/
